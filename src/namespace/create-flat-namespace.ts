...
export function createFlatNamespace(): FlatErrorNamespace {
	return {
		...
		unsupportedMediaType: (detail: unknown) => new clientErrors.UnsupportedMediaTypeError(detail),
		...
		preconditionRequired: (detail: unknown) => new clientErrors.PreconditionRequiredError(detail),
		...
		insufficientStorage: (detail: unknown) => new serverErrors.InsufficientStorageError(detail),
